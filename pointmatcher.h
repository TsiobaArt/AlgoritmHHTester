...
public:
    ...
    std::vector<Point> reference_pointsTest = { // вектор еталонних значень для тесту
        {50.4599, 30.4441, 0,0,0,0},//3
        {50.4584, 30.4402, 0,0,0,0},// 4
        {50.4624, 30.4374, 0,0,0,0}, // 2
        {50.4629, 30.4420, 0,0,0,0}, // 1
        {50.4607, 30.4360, 0,0,0,0}//5
    };

    std::vector<Point> candidate_pointsTest = { //  вектор точок кандидатів для тесту
        {50.5129, 30.4920, 0,0,0,0},//*1
        {50.5099, 30.4941, 0,0,0,0},//*3
        {50.5129, 30.4948, 0,0,0,0},//*1test


        {50.4086, 30.6245, 0,0,0,0}, // Теремки
        {50.5223, 30.4981, 0,0,0,0}, // Троещина
        {50.4607, 30.4323, 0,0,0,0},//
        {50.5124, 30.4874, 0,0,0,0},//*2
        {50.4131, 30.6767, 0,0,0,0}, // Бортничи
        {50.5084, 30.4902, 0,0,0,0},//*4
        {50.5084, 30.4920, 0,0,0,0},//*4test
        {50.5124, 30.4854, 0,0,0,0},//*2 test

        {50.5084, 30.4925, 0,0,0,0},//*4test
        {50.5087, 30.4924, 0,0,0,0},//*4test

        {50.5034,30.4383, 0,0,0,0},//
        {50.4625,30.4417, 0,0,0,0}, // new
        {50.4549,30.3968, 0,0,0,0}, // new
        {50.4625,30.4272, 0,0,0,0}, // new
        {50.5034,30.4233, 0,0,0,0},//
        {50.4625,30.44123, 0,0,0,0}, // new
        {50.4549,30.3458, 0,0,0,0}, // new
        {50.4583, 30.432447, 0,0,0,0}, // new
        {50.5034,30.454383, 0,0,0,0},//
        {50.4625,30.423417, 0,0,0,0}, // new
        {50.5098, 30.43441, 0,0,0,0},//*3 testt
        {50.4583,30.478447, 0,0,0,0},  // new
        {50.4549,30.324968, 0,0,0,0}, // new
        {50.4625,30.4643272, 0,0,0,0}, // new
        {50.5034,30.64383, 0,0,0,0},//
        {50.4625,30.74417, 0,0,0,0}, // new

        {50.4597, 30.4444, 0,0,0,0},//3
        {50.4582, 30.4405, 0,0,0,0},// 4
        {50.4622, 30.4377, 0,0,0,0}, // 2
        {50.4627, 30.4423, 0,0,0,0}, // 1
        {50.4605, 30.4363, 0,0,0,0},//5

        {50.4549,30.32348, 0,0,0,0}, // new
        {50.4583, 30.41232447, 0,0,0,0}, // new
        {50.5034,30.443454383, 0,0,0,0},//
        {50.4625,30.12323417, 0,0,0,0}, // new
        {50.4583,30.21378447, 0,0,0,0},  // new
        {50.4549,30.23424968, 0,0,0,0}, // new
        {50.4625,30.456643272, 0,0,0,0}, // new
        {50.5034,30.6574383, 0,0,0,0},//
        {50.4625,30.124417, 0,0,0,0}, // new
        {50.4549,30.3458, 0,0,0,0}, // new
        {50.5034,30.23454383, 0,0,0,0},//
        {50.4625,30.423417, 0,0,0,0}, // new
        {50.5109, 30.4967, 0,0,0,0},//3*test
        {50.5109, 30.4867, 0,0,0,0},//3*test
        {50.5179, 30.4966, 0,0,0,0},//3*test
        {50.5119, 30.4957, 0,0,0,0},//3*test

        {50.4583,30.23478447, 0,0,0,0},  // new
        {50.4549,30.324968, 0,0,0,0}, // new
        {50.4625,30.432443272, 0,0,0,0}, // new
        {50.5034,30.234383, 0,0,0,0},//
        {50.4625,30.74417, 0,0,0,0}, // new
        {50.4549,30.234458, 0,0,0,0}, // new
        {50.4583, 30.23432447, 0,0,0,0}, // new
        {50.5034,30.454383, 0,0,0,0},//
        {50.4625,30.56723417, 0,0,0,0}, // new
        {50.4583,30.65778447, 0,0,0,0},  // new
        {50.4549,30.34524968, 0,0,0,0}, // new
        {50.4625,30.4567643272, 0,0,0,0}, // new
        {50.5034,30.3454383, 0,0,0,0},//
        {50.4625,30.3454417, 0,0,0,0}, // new

        {50.4549,30.43968, 0,0,0,0}, // new
        {50.4625,30.24272, 0,0,0,0}, // new
        {50.4583, 30.14747, 0,0,0,0}, // new
        {50.4269, 30.309, 0,0,0,0},//
        {50.5107, 30.4860, 0,0,0,0},//*5
        {50.4131, 30.6767, 0,0,0,0} // Бортничи
                                              };
    double getRcs() const;
